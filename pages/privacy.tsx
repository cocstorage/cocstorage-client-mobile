    ...
    <GeneralTemplate header={<PrivacyHeader />}>
      <Flexbox component="section" direction="vertical" gap={20} customStyle={{ margin: '20px 0' }}>
        ...
        <Flexbox direction="vertical" gap={8}>
          ...
          <Typography>
            개념글 저장소는 회원의 회원가입일로부터 회원탈퇴와 같은 개인정보 수집, 이용, 제공에 대한
            동의 철회 시까지 회원의 개인정보를 보유 및 이용하게 됩니다. 회원의 개인정보는 원칙적으로
            개인정보의 수집 및 이용 목적이 달성된 시점에 지체없이 파기합니다.
          </Typography>
        ...
        <Flexbox direction="vertical" gap={8}>
          <Typography variant="h4">6. 개인정보 보관 및 보호를 위한 기술적, 관리적 대책</Typography>
          <Typography>
            개념글 저장소는 회원의 개인정보를 취급함에 있어 개인정보 분실, 도단, 누출, 변조 또는
            훼손되지 않도록 안정성 확보를 위하여 다음과 같은 기술적, 관리적 대책을 강구합니다.
          </Typography>
          <Typography>
            - 회원가입 및 로그인 시 암호 알고리즘을 이용하여 네트워크상의 개인정보를 안전하게 전송할
            수 있도록 Secured Socket Layer(SSL)를 채택하고 있습니다.{' '}
          </Typography>
          <Typography>
            - 회원의 비밀번호는 암호화 되어 저장 및 관리되고 있어, 본인만이 알 수 있습니다.
          </Typography>
          <Typography>
            - 개인정보에 대한 접근권한을 개인정보보호 책임자, 기타 업무상 개인정보의 처리가 불가피한
            자로 제한하며, 그 이외의 인원이 개인정보에 접근하는 것을 허용하지 않습니다.
          </Typography>
        </Flexbox>
        <Flexbox direction="vertical" gap={8}>
          ...
          <Typography>
            ...
            구글은 구글 광고 쿠키, 익명 식별자, 구글 애널리틱스 쿠키 등을 이용하여 인구통계 정보 및
            관심분야에 대한 정보를 수집하며, 이용자는 구글 애널리틱스 Opt-out Browser Add-on 을
            이용하여 스스로를 구글의 프로그램에서 배제(opt-out)시킬 수 있습니다. 구글 애널리틱스
            Opt-out Browser Add-on 은 https://tools.google.com/dlpage/gaoptout/를 방문하여 이용하실
            수 있습니다.
          </Typography>
        </Flexbox>
        <Flexbox direction="vertical" gap={8}>
        ...
        <Flexbox direction="vertical" gap={8}>
          ...
          <Typography>
            이 개인정보처리방침은 2020년 2월 23일부터 적용되며, 개인정보처리방침 내용에 변경이 있을
            경우 개정 최소 7일전, 회원의 권리에 중대한 변경이 발생할 경우에는 최소 30일전에 개념글
            저장소 홈페이지를 통해 고지합니다.
          </Typography>
        </Flexbox>
      </Flexbox>
