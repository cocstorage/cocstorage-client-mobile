...
function PolicyHead() {
  ...
  return (
    <Head>
      ...
      <meta property="og:url" content="https://m.cocstorage.com/policy" />
      ...
      <meta property="twitter:url" content="https://m.cocstorage.com/policy" />
      ...
      <link rel="canonical" href="https://m.cocstorage.com/policy" />
    </Head>
  );
}
