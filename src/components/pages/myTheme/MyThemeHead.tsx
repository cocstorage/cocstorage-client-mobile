...
function MyThemeHead() {
  ...
  return (
    <Head>
      ...
      <meta property="og:url" content="https://www.cocstorage.com/setting/theme" />
      ...
      <meta property="twitter:url" content="https://www.cocstorage.com/setting/theme" />
      ...
      <link rel="canonical" href="https://www.cocstorage.com/setting/theme" />
    </Head>
  );
}
