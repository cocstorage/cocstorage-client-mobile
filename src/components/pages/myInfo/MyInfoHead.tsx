...
function MyInfoHead() {
  ...
  return (
    <Head>
      ...
      <meta property="og:url" content="https://www.cocstorage.com/setting/info" />
      ...
      <meta property="twitter:url" content="https://www.cocstorage.com/setting/info" />
      ...
      <link rel="canonical" href="https://www.cocstorage.com/setting/info" />
    </Head>
  );
}
